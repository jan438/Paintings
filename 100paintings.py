...
c.drawString(infox + 100, infoyline - 20, paintingsdata[index][1])
c.setFont(paintingfont, 20)
c.drawString(infox + 100, infoyline - 100.0, paintingsdata[index][7])
c.drawString(infox + 100, infoyline - 75.0, paintingsdata[index][8])
c.drawString(infox + 100, infoyline - 50.0, paintingsdata[index][9])
c.save()
key = input("Wait")
